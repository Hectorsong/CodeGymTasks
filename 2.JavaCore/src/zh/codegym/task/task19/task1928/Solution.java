package zh.codegym.task.task19.task1928;
...
public class Solution {
    ...
    {
        System.out.println("这是 Solution 类");
    }
    ...
    public static void main(String... args) throws IOException {
        try (
            ...
            int value = 123_456_789;//加下划线增强可读性
    ...
    class B implements Example {
        {
            System.out.println("这是 B 类");
        }
    }

    class C extends A {
        {
            System.out.println("这是 C 类");
        }
    }
}
